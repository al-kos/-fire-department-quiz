...
async function initDb() {
  ...
  // Проверка существования таблицы 'quiz_questions'
  try {
  ...
  `;
    ...
    // Если таблица уже существует, просто выходим из функции
    if (tableExists) {
      return;
    }
    ...
    const questions = [
      ...
      {
        question: 'Каким образом следует эвакуироваться из здания при пожаре?',
        option1: 'На лифте',
        option2: 'По лестнице',
        option3: 'Через окна',
        answer: 'По лестнице',
